package com.redsystem.proyectochatapp_kotlin.Adaptador
...
class AdaptadorChat (contexto : Context, chatLista : List<Chat>, imagenUrl : String)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
        return if (position == 1){
            val view : View = LayoutInflater.from(contexto).inflate(com.redsystem.proyectochatapp_kotlin.R.layout.item_mensaje_derecho, parent, false)
            ViewHolder(view)
        }else{
            val view : View = LayoutInflater.from(contexto).inflate(com.redsystem.proyectochatapp_kotlin.R.layout.item_mensaje_izquierdo,parent, false)
            ViewHolder(view)
        }
    }
